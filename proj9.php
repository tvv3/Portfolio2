<?php
$i=9;
$titlu="Task Management v7b";//se fol in title si in #abouProject
$demolink="#";
...
$descriere_detaliata_proiect="Proiectul Task Management v7b contine partea de api in laravel 11 cu useri, roluri, taskuri, comentarii si echipe pentru fiecare task si autorizare, autentificare prin Sanctum cookies si o parte separata pentru frontend in Vue js 3. Api-ul va rula pe localhost port 8000 iar vue js pe localhost port 3000.";
